...
if (userInput === CORRECT_PASSWORD) {
    showMessage(`
        ...
        <p class="mt-2 text-xl glow-text">DEIN GESCHENK IST: Eine halbe Packung Cornflakes</p>
        <p class="mt-4 italic">Viel Spaß damit! Und möge die Macht der Cornflakes mit dir sein! 🖖</p>
        `, true);
